document.addEventListener("DOMContentLoaded", function () {
    ...
    $("#nom_estudiante").autocomplete({
        ...
        select: function (event, ui) {
            $("#id").val(ui.item.id);
            $("#nom_estudiante").val(ui.item.label);
            $("#tel_estudiante").val(ui.item.telefono);
            $("#dir_estudiante").val(ui.item.direccion);
        }
    })
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response != 'error') {
                        ...
                        setTimeout(() => {
                            generarPDF(res.id_estudiante, res.id_venta);
                            location.reload();
                        }, 300);
                    } else {
                        Swal.fire({
...
function generarPDF(estudiante, id_venta) {
    url = 'pdf/generar.php?cl=' + estudiante + '&v=' + id_venta;
